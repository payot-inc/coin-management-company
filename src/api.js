...
export default {
  ...
  addService(machineId, service) {
    const path = getPath('/service/machine/:id', { id: machineId });

    return axios.post(path, service);
  },

  removeService(serviceId) {
    const path = getPath('/service/:id', { id: serviceId });
  ...
  claimMachine(machineId, price, reason) {
    ...
    return axios.post(path, { amount: price, reason });
  },
